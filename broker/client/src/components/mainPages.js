...
const handleRegistration = async () => {
    const resp = await fetch('http://localhost:8000/broker/preregister');
    ...
    const verificationResp = await fetch('http://localhost:8000/broker/register', {
        method: 'POST',
            ...
            <section id="authentication">
              <form onSubmit={stopSubmit}>
                ...
                <button onClick={() => handleVerification()}>
                  <strong>🔐 Login to WebApp</strong>
                </button>
              </form>
              <p id="authSuccess" className="success"></p>

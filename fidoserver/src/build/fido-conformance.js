...
(0, node_fetch_1.default)('https://mds3.fido.tools/getEndpoints', {
    method: 'POST',
    body: JSON.stringify({ endpoint: `${server_2.expectedOrigin}${exports.fidoRouteSuffix}` }),
...
exports.fidoConformanceRouter.post('/attestation/result', async (req, res) => {
    ...
    try {
        verification = await (0, server_1.verifyRegistrationResponse)({
            ...
            expectedOrigin: server_2.expectedOrigin,
            supportedAlgorithmIDs,
...
exports.fidoConformanceRouter.post('/assertion/result', async (req, res) => {
    ...
    const existingDevice = user.devices.find(device => helpers_1.isoUint8Array.areEqual(device.credentialID, credIDBuffer));
    if (!existingDevice) {
...
server_1.SettingsService.setRootCertificates({ identifier: 'mds', certificates: [exports.MDS3ROOT] });
// Reset preset root certificates
server_1.SettingsService.setRootCertificates({ identifier: 'apple', certificates: [] });
server_1.SettingsService.setRootCertificates({ identifier: 'android-key', certificates: [] });
server_1.SettingsService.setRootCertificates({ identifier: 'android-safetynet', certificates: [] });
